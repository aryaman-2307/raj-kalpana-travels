        ...
        <div className="flex flex-col h-full overflow-y-auto">
          ...
          <div className="border-t border-border px-5 py-4 bg-surface">
            <div className="space-y-2.5 text-sm text-muted">
              <a href={`tel:+91${COMPANY_PHONE}`} className="flex min-h-11 items-center gap-2 transition-colors hover:text-navy">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                +91 {COMPANY_PHONE}
              </a>
              <a href={`mailto:${COMPANY_EMAIL}`} className="flex min-h-11 items-center gap-2 transition-colors hover:text-navy">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
