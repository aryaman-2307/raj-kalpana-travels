        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <div className="space-y-3.5 mb-7">
              ...
              <a href={`tel:+91${COMPANY_PHONE}`} className="flex min-h-11 items-center gap-3 py-1 text-sm text-white/60 transition-colors hover:text-amber">
              ...
              <a href={`mailto:${COMPANY_EMAIL}`} className="flex min-h-11 items-center gap-3 py-1 text-sm text-white/60 transition-colors hover:text-amber">
                <svg className="w-4 h-4 text-red-accent shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
